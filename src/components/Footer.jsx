    ...
    <>
      ...
      <footer className="flex flex-col space-y-10 justify-center items-center m-10">
        ...
        <nav className="flex justify-center flex-wrap gap-6 text-gray-500 font-medium">
          <a onClick={() => scrollToSection(refs?.footerRef)} className="hover:text-gray-900">
            Contact
          </a>
          <a onClick={() => scrollToSection(refs?.questionsRef)} className="hover:text-gray-900">
            Question
          </a>
          <a onClick={() => scrollToSection(refs?.expertsRef)} className="hover:text-gray-900">
            Experts
          </a>
          <a onClick={() => scrollToSection(refs?.servisesRef)} className="hover:text-gray-900">
            Services
          </a>
        ...
        <div className="flex justify-center gap-4 text-gray-600">
          {/* Telegram */}
          <a href="https://t.me/poupaksepehr" target="_blank" rel="noopener noreferrer">
          ...
          {/* WhatsApp */}
          <a href="https://chat.whatsapp.com/DsqNXRawTp6IsYSrEbZdYT" target="_blank" rel="noopener noreferrer">
          ...
          {/* Instagram */}
          <a href="https://www.instagram.com/poupaksepehr/profilecard/?igsh=YXB3amFqNml4OWxo" target="_blank" rel="noopener noreferrer">
          ...
          {/* Facebook */}
          <a href="https://www.facebook.com/share/18jPfbULvG/" target="_blank" rel="noopener noreferrer">
          ...
          {/* Youtube */}
          <a href="https://www.youtube.com/@poupaksepehr" target="_blank" rel="noopener noreferrer">
          ...
          {/* Telephone */}
          <a href="tel:09389059097" target="_blank" rel="noopener noreferrer">
